        ...
        <div className="mx-auto flex flex-col gap-6 px-10">
          ...
          <div className="flex flex-col gap-2">
            <h2 className="text-xl font-bold flex items-center gap-2">
              <span className="bg-orange-500 w-3 h-3 rounded-sm"></span> Clutch Zone
            </h2>
          ...
          <div className="flex flex-wrap gap-4 mt-4">
            <button className="bg-orange-500 text-white px-6 py-2 rounded-md text-sm font-semibold hover:bg-orange-600">
              TRY PLAYGROUND
            </button>
