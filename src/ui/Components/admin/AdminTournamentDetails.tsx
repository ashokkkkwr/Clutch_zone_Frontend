        ...
        <div className="col-span-2 space-y-6">
          ...
          <div className="bg-gray-800/50 p-4 rounded-lg flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <img
                src={tournament.games[0]?.game_icon_image || 'https://placeholder.com/100'}
                alt={tournament.games[0]?.game_name}
                className="w-12 h-12 rounded"
              />
              <div>
                <h3 className="font-bold">{tournament.games[0]?.game_name}</h3>
                <p className="text-sm text-gray-400">{tournament.tournament_game_mode}</p>
              </div>
            </div>
          ...
          <div className="bg-gray-800/50 p-4 rounded-lg">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-400 mt-1">{tournament.tournament_start_date}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-800/50 p-4 rounded-lg">
            ...
            <p className="text-sm text-gray-400 mb-4">{tournament.tournament_description}</p>
          </div>
